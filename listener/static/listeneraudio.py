...
class Ui_ListenerAudio(object):
    def setupUi(self, ListenerAudio):
        ...
        icon1 = QIcon()
        icon1.addFile(
            u"static/microphone-inactive.svg", QSize(), QIcon.Normal, QIcon.Off
        )
        icon1.addFile(
            u"static/microphone-recording.svg", QSize(), QIcon.Normal, QIcon.On
        )
    ...
    def retranslateUi(self, ListenerAudio):
        ListenerAudio.setWindowTitle(
            QCoreApplication.translate("ListenerAudio", u"A&udio", None)
        )
        # if QT_CONFIG(tooltip)
        self.input_select.setToolTip(
            QCoreApplication.translate(
                "ListenerAudio", u"Choose the pulse-audio source", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.volume_control.setToolTip(
            QCoreApplication.translate("ListenerAudio", u"Modify recording level", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.enable_audio.setText(
            QCoreApplication.translate("ListenerAudio", u"Microphone", None)
        )
